...
export class HairSimulation {
    ...
    _initTextures() {
        ...
        this.rootOffsetTex = makeTex(rootOffData)
        this.zeroTex = makeTex(new Float32Array(total * 4))
    }
    ...
    _initCompute() {
        ...
        Object.assign(this.sphereColVar.material.uniforms, {
            ...
            uComplianceSph: { value: PARAMS.sphere_collision_compliance },
            uSubDt: { value: 0.0 },
        })
    ...
    update(dt, sphereCenter, sphereQuaternion, isDragging, frameDelta, elapsedTime) {
        ...
        for (let step = 0; step < PARAMS.num_substeps; step++) {
            ...
            this.sphereColVar.material.uniforms.uSubDt.value = subDt
